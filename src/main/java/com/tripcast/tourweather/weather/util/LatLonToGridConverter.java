package com.tripcast.tourweather.weather.util;

public final class LatLonToGridConverter {
    ...
    private static final double DEGREE_TO_RADIAN =
            Math.PI / 180.0;

    private LatLonToGridConverter() {
    }

    public static GridCoordinate convert(
            double latitude,
            double longitude
    ) {
        ...
        double slat1 =
                STANDARD_LATITUDE_1 * DEGREE_TO_RADIAN;
        double slat2 =
                STANDARD_LATITUDE_2 * DEGREE_TO_RADIAN;

        double olon =
                ORIGIN_LONGITUDE * DEGREE_TO_RADIAN;
        double olat =
                ORIGIN_LATITUDE * DEGREE_TO_RADIAN;
        ...
        double theta =
                longitude * DEGREE_TO_RADIAN - olon;
